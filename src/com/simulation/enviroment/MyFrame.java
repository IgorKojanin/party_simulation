...
public class MyFrame extends JFrame {
	...
	public MyFrame() {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            // Check if the mouse click is within the bounds of the "DJ" text
            int djX = squares[16][1].x ; // Adjusted x-coordinate for the center of the square
            int djY = squares[16][1].y ; // Adjusted y-coordinate for the center of the square
            int djWidth = 30; // Adjusted width of the square
            int djHeight = 30; // Adjusted height of the square

            if (mouseX >= djX && mouseX <= djX + djWidth && mouseY >= djY && mouseY <= djY + djHeight) {
                // Perform actions when "DJ" text is clicked
                handleDJClick();
            }
        }
    });
	...
	private void handleDJClick() {
        // Add your logic for handling the click on the "DJ" text here
        // For example, open the music input frame
        // JFrame inputFrame = new JFrame("Music Input");
		System.out.println("DJ Clicked");
        // Set up your input frame components and logic here
        // ...
