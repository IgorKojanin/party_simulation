...
public class JoeMama extends Avatar implements PartyGoer {
	...
	public void talk(PartyGoer person) {
		// TODO		
		// create a list of answers and questions that you would like to exchange with the other users of Club Penguin
		// create a primitive algorithm that would make picks from your answer list based on the questions asked
	}
	...
	public void playFussball() { // Play Fussball only on the designate spot
		// TODO 
		// if two players interact in the fussball area, prompt the option to start a game
	...
	public Direction moveAvatar() {
		// TODO
		// create an algorithm that determines the next step of your movement pattern based on a set of priorities.
