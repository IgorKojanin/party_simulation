...
hinderniss = false;
if(myMap[myX][myY+1] == Places.PATH || myMap[myX][myY+1] == Places.DANCEFLOOR || myMap[myX][myY+1] == Places.BAR_CHAIR || myMap[myX][myY+1] == Places.FUSSBALL_CHAIR || myMap[myX][myY+1] == Places.LOUNGE_BIG || myMap[myX][myY+1] == Places.LOUNGE_SMALL || myMap[myX][myY+1] == Places.LOUNGE_SMOKING || myMap[myX][myY+1] == Places.POOL_CHAIR  ) {//hier will ich nach rechts versetzen
	myY = myY+1;
	myHeading = Heading.NORTH;
...
if(myMap[myX+1][myY] == Places.PATH || myMap[myX+1][myY] == Places.DANCEFLOOR || myMap[myX+1][myY] == Places.BAR_CHAIR || myMap[myX+1][myY] == Places.FUSSBALL_CHAIR || myMap[myX+1][myY] == Places.LOUNGE_BIG || myMap[myX+1][myY] == Places.LOUNGE_SMALL || myMap[myX+1][myY] == Places.LOUNGE_SMOKING|| myMap[myX+1][myY] == Places.POOL_CHAIR  ){
	myX = myX+1;
	myHeading = Heading.WEST;
...
private Direction RightWallDetected(){ //letzen schritt ruckgaengig machen..
	Direction dir = Direction.LEFT;
	return dir;
}
private Direction LeftWallDetected(){ //letzen schritt ruckgaengig machen..
...
private boolean isFree(int myx, int myy){
	if(myMap[myx][myy] == Places.PATH || myMap[myx][myy] == Places.DANCEFLOOR || myMap[myx][myy] == Places.BAR_CHAIR || myMap[myx][myy] == Places.FUSSBALL_CHAIR || myMap[myx][myy] == Places.LOUNGE_BIG || myMap[myx][myy] == Places.LOUNGE_SMALL || myMap[myx][myy] == Places.LOUNGE_SMOKING || myMap[myx][myy] == Places.POOL_CHAIR  ){
		return true;
	}
	else{
	return false;
