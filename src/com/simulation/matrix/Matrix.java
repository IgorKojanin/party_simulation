...
public class Matrix {
	...
	public Matrix() {
		...
		// Emmanuel igor = new Emmanuel(Shape.CIRCLE, Color.CYAN, 0, 20, "Igor", 0);
		...
		Bjoern bjoern = new Bjoern(Shape.SQUARE, Color.GREEN, 0, 20, "Björn", 0);
		Bernhard bernhard = new Bernhard(Shape.CIRCLE, Color.YELLOW, 0, 20, "Bernhard",0);
		Jose Jose = new Jose(Shape.CIRCLE, Color.LIGHT_GRAY, 1, 20, "JoseLu", 0);
		// Celestine celestine  = new Celestine();
		Kieran kieran = new Kieran(Shape.TRIANGLE, Color.ORANGE, 1, 20, "Kieran", 0);
